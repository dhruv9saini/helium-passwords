...
open_phone_trackpad_activity() {
  ...
  url="http://127.0.0.1:${port}/?sensitivity=${X11_PHONE_TRACKPAD_SENSITIVITY:-1.00}&scroll=${X11_PHONE_TRACKPAD_SCROLL_SENSITIVITY:-0.13}"
  (
