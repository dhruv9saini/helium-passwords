...
STATE_DIR=${PHONE_THERMAL_GUARD_STATE_DIR:-/data/local/helium-phone-thermal-guard}
...
SEVERE_CAP=${PHONE_THERMAL_SEVERE_CAP:-${ARCH_DESKTOP_THERMAL_SEVERE_CAP:-25}}
CRITICAL_CAP=${PHONE_THERMAL_CRITICAL_CAP:-${ARCH_DESKTOP_THERMAL_CRITICAL_CAP:-15}}
